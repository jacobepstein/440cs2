  ...
  server = function(input, output){
    ...
    observeEvent({
     ...
     output$scatter = renderPlot({
       ...
       ggplot(data = regionset, aes(x= x, y=y, na.rm = TRUE))+ geom_point(aes(colour = factor(regionset$Region), size=Population)) + ylab(input$outcome) + xlab(input$selector) + geom_smooth(method='lm',formula=y~x) + labs(color="Region")
       })
      }
    )
  }
